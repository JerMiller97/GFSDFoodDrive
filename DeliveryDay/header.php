...
session_start();
if ($_SESSION["PermissionLevel"] == 9 or $_SESSION["PermissionLevel"] == 7) {
	?>
...
if ($_SESSION["PermissionLevel"] == 9)
	...
	print "
		...
		<li class=\"nav-item\">
		<a class=\"nav-link\" href=\"/Santa/\">Santa</a>
		</li>
		<li class=\"nav-item\">
		<a class=\"nav-link active\" href=\"/DeliveryDay/\">Delivery Day</a>
		</li>

	";
	
	if ($_SESSION["PermissionLevel"] == 9 or $_SESSION["PermissionLevel"] == 8)
